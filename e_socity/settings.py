"""
Django settings for e_socity project.
...
SECRET_KEY = 'django-insecure-9t@xzr+k_+_cwasleo!ch!x$x+d$kb34)*(-c!jozlyriq1#88'
...
WSGI_APPLICATION = 'e_socity.wsgi.application'
